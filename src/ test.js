require.register("test", function (module, exports, require) {
  ...
  // src/index.ts
  globalThis.reduxToolkit = __markAsModule(exports);
  __export(exports, {
  ...
  var createDraftSafeSelector = function () {
    ...
    var wrappedSelector = function (value) {
      ...
      return selector.apply(
        ...
        __spreadArray(
          [
            (0, import_immer.isDraft)(value)
              ? (0, import_immer.current)(value)
              : value,
          ],
          rest
        )
    ...
    if (thunk) {
      if (isBoolean(thunk)) {
        ...
        middlewareArray.push(
          import_redux_thunk.default.withExtraArgument(thunk.extraArgument)
        );
      }
    }
    if (true) {
  ...
  function configureStore(options) {
    ...
    var middlewareEnhancer = (0, import_redux2.applyMiddleware).apply(
      void 0,
      finalMiddleware
    );
    ...
    return (0,
    import_redux2.createStore)(rootReducer, preloadedState, composedEnhancer);
  }
  // src/createAction.ts
  ...
  function createReducer(
    ...
    if (isStateFunction(initialState)) {
      ...
      var frozenInitialState_1 = (0, import_immer2.default)(
        initialState,
        function () {}
      );
      getInitialState = function () {
  ...
  function createSlice(options) {
    ...
    var initialState =
      typeof options.initialState == "function"
        ...
        : (0, import_immer5.default)(options.initialState, function () {});
  ...
  var createPause = function (signal) {
    return function (promise) {
      return catchRejection(
        Promise.race([promisifyAbortSignal(signal), promise]).then(function (
          output
        ) {
